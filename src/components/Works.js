...
const Works = () => {
    ...
    return ( 
        <div className="project">
            <div className="project-item"><img src="/assets/work9.png" alt="projects" />
                <div className="project-content">
                    <h3 className="title">Ellcrys</h3>
                    <a href="https://www.ellcrys.org/team" className="" target='_blank' rel='noreferrer'>Ellcrys </a>
                    {/* <a href="www." */}
                
                </div>
            </div>

            <div className="project-item"><img src="/assets/work8.png" alt="projects" />
                <div className="project-content">
                    <h3 className="title">Orokolabs</h3>
                    <a href="https://www.orokolabs.co" className="" target='_blank' rel='noreferrer'>Github </a>
                    <a href="https://www.figma.com/file/oGt6rWYoJNxMhE6b9d75Fi?node-id=0:1" className=""target='_blank' rel='noreferrer'>UI Design </a>
            ...
            <div className="project-item"><img src="/assets/work4.png" alt="projects" />
                <div className="project-content">
                    ...
                    <a href="https://www.ugoo.pro" className="" target='_blank' rel='noreferrer'>Ugoo.pro </a>
                    <a href="https://github.com/emmich/myself" className="" target='_blank' rel='noreferrer'>Github </a>
